// The "GamingLaptopPrice" class.
import java.io.*;
import java.util.*;
import java.awt.*;
import hsa.*;

public class GamingLaptopPrice
{
    ...
    protected String[] gpu2Price = new String [999];
    ...
    public void gameIden () throws IOException
    {
	String gamePriceFile = "laptopGamingPrice.txt";
	String str;

	BufferedReader infile;
	infile = new BufferedReader (new FileReader (gamePriceFile));
	...
	for (int i = 0 ; i < this.size ; i++)
	{
	    ...
	    this.gpu2Price [i] = infile.readLine ();
    ...
    public int printGpu2Price (int i)
    {

	this.price7 [i] = Integer.parseInt (this.gpu2Price [i]);
	...
	this.price8 [i] = Integer.parseInt (this.ramPrice [i]);
	...
	this.price9 [i] = Integer.parseInt (this.batteryPrice [i]);
	...
	this.price0 [i] = Integer.parseInt (this.techPrice [i]);
	return this.price0 [i];
    }
} // GamingLaptopPrice class
